 ...
 *     Снимает скриншот текущего состояния браузера и прикладывает его в Allure отчет.
 *     Сохраняет HTML исходный код текущей страницы и прикладывает его в Allure отчет.
